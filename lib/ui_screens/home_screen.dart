...
class _HomeState extends State<Home> {
  ...
  static const CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(31.449272073433534, 31.65736801116148),
    zoom: 16.4746,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromRGBO(182, 139, 26, 1),
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                Image.asset('assets/images/persons/presidentwelcom.png',
                    fit: BoxFit.cover),
                Padding(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(
                      'assets/images/banner/bannerb.png',
                      scale: 1,
                      //fit: BoxFit.contain,
                    ),
                  ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text(
                    "© 2020 - All Rights Reserved to Horus",
                    style: GoogleFonts.robotoSlab(
                      fontSize: 14,
                      color: const Color.fromRGBO(32, 17, 98, 1),
                      fontWeight: FontWeight.bold,
                ...
                Center(
                  child: Text(
                    "University in Egypt - App Developed by A.Elshafee",
                    style: GoogleFonts.robotoSlab(
                      fontSize: 14,
                      color: const Color.fromRGBO(32, 17, 98, 1),
                      fontWeight: FontWeight.bold,
